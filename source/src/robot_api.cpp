...
Eigen::VectorXd RobotAPI::inverse_kinematics(const Eigen::Matrix4d target_pose,
...
Eigen::MatrixXd RobotAPI::forward_kinematics(const Eigen::VectorXd& joint_target) {
